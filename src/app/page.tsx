  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-[700px] mx-auto min-h-screen bg-white relative">
        ...
        {/* 헤더 - 고정 */}
        <header className="fixed top-0 left-1/2 -translate-x-1/2 w-full max-w-[700px] z-50 bg-[#df0012] pb-8 before:absolute before:bottom-0 before:left-0 before:w-3 before:h-3 before:bg-white before:rounded-tl-xl after:absolute after:bottom-0 after:right-0 after:w-3 after:h-3 after:bg-white after:rounded-tr-xl">
          {/* 상단 바 */}
