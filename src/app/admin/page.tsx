          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="bg-white rounded-xl p-4">
              ...
              <div className={`flex items-center gap-1 mt-2 text-sm ${
                stats.compared.orders >= 0 ? 'text-[var(--color-success-500)]' : 'text-[var(--color-error-500)]'
              }`}>
                {stats.compared.orders >= 0 ? (
                  <TrendingUp className="w-4 h-4" />
                ) : (
                  <TrendingDown className="w-4 h-4" />
                )}
                <span>전일 대비 {stats.compared.orders >= 0 ? '+' : ''}{stats.compared.orders}%</span>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-4">
              ...
              <div className={`flex items-center gap-1 mt-2 text-sm ${
                stats.compared.sales >= 0 ? 'text-[var(--color-success-500)]' : 'text-[var(--color-error-500)]'
              }`}>
                {stats.compared.sales >= 0 ? (
                  <TrendingUp className="w-4 h-4" />
                ) : (
                  <TrendingDown className="w-4 h-4" />
                )}
                <span>전일 대비 {stats.compared.sales >= 0 ? '+' : ''}{stats.compared.sales}%</span>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-4">
              ...
              <p className="text-sm text-[var(--color-neutral-400)] mt-2">현재 접속중</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-4">
              ...
              <p className="text-sm text-[var(--color-neutral-400)] mt-2">배달 가능</p>
            </div>
          </div>
        </section>
